...
/**
 * صفحه Assessment - پرسش‌های تشخیصی هوشمند
 */
public class AssessmentActivity extends Activity {
    ...
    void shell() {
        ...
        questionNumber = tv("سؤال 1 از 21", 14, BLUE, true);
    ...
    void showQuestion() {
        ...
        // بروزرسانی شماره سؤال
        questionNumber.setText("سؤال " + assessmentEngine.getCurrentQuestionNumber() + " از " + assessmentEngine.getTotalQuestions());
        ...
        // پاک کردن جوابات قدیمی
        answersContainer.removeAllViews();
        
        // نمایش ورودی بر اساس نوع سؤال
        if (q.type.equals("text")) {
            ...
            // بازیابی جواب قدیمی اگر وجود داشته باشد
            ...
            answerInput.setTextColor(TEXT);
            answerInput.setTextSize(14);
            answerInput.setInputType(android.text.InputType.TYPE_CLASS_NUMBER | android.text.InputType.TYPE_NUMBER_FLAG_DECIMAL);
            ...
            String[] options = parseOptions(q.text);
    ...
    String[] parseOptions(String text) {
